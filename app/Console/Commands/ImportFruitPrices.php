...
//                             {markets* : The markets to fetch prices for} 
//                             {date* : The date to fetch prices in}';
    
//     protected $description = 'Fetch market prices from API and store in database';

//     public function handle(MarketDataService $marketDataService)
//     {
//         $markets = $this->argument('markets');
//         $date = $this->option('date');
        
//         $this->info("Fetching prices for: " . implode(', ', $markets) . " in $date");
        
//         if ($marketDataService->fetchAndStorePrices($markets, $date)) {
//             $this->info('Successfully fetched and stored market prices.');
//             return 0;
//         }
        
//         $this->error('Failed to fetch market prices.');
//         return 1;
//     }
